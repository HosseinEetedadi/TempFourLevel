...
x, y = UtilsPlot.plot_data_average_lag_over_time(0, llna_db_file, job_type=0, max_fps=FPS_LIMITS_MAX[0], average_every_secs=average_every_secs)
x_arr.append(x)
y_arr.append(y)

x, y = UtilsPlot.plot_data_average_lag_over_time(0, llna_db_file, job_type=1, max_fps=FPS_LIMITS_MAX[1], average_every_secs=average_every_secs)
x_arr.append(x)
y_arr.append(y)

x, y = UtilsPlot.plot_data_average_lag_over_time(0, llna_db_file, job_type=2, max_fps=FPS_LIMITS_MAX[2], average_every_secs=average_every_secs)
x_arr.append(x)
y_arr.append(y)

x, y = UtilsPlot.plot_data_average_lag_over_time(0, llna_db_file, job_type=3, max_fps=FPS_LIMITS_MAX[3], average_every_secs=average_every_secs)
x_arr.append(x)
y_arr.append(y)
...
figure_filename = f"./_plots/average-lag-over-time_{llna_db_folder}_{Utils.current_time_string()}.pdf"
