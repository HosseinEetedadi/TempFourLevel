...
class Job:
    ...
    def a_in_queue(self):
        ...
        # print(f"name of the job is: {self._job_type} and the time is equal to:  {self._time_queued} -+-+-++-+-+-+-+-+")
    ...
    def set_transmission_next_action(self, action: Job.TransmissionAction):
        # print(f"this is the action: {action}\nAnd this is the transmission action list: {self._transmission_actions_list}")
