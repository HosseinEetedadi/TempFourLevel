...
x_rewards_1, y_rewards_1 = UtilsPlot.plot_data_reward_over_time(5, DB_FILE, average_every_secs=average_every_secs)
x_rewards_2, y_rewards_2 = UtilsPlot.plot_data_reward_over_time(10, DB_FILE, average_every_secs=average_every_secs)
