...
sarsa_db_folder = "20230725-123052"
sarsa_db_file = f"./_log/learning/D_SARSA/WORKERS_OR_CLOUD/{sarsa_db_folder}/log.db"
print(sarsa_db_file)
x_sarsa_rewards, y_sarsa_rewards = UtilsPlot.plot_data_in_deadline_over_time(0, sarsa_db_file, average_every_secs=average_every_secs)

sarsa_nc_db_folder = "20210929-061953"
sarsa_nc_db_file = f"./_log/learning/D_SARSA/ONLY_WORKERS/{sarsa_nc_db_folder}/log.db"
print(sarsa_nc_db_file)
x_sarsa_nc_rewards, y_sarsa_nc_rewards = UtilsPlot.plot_data_in_deadline_over_time(0, sarsa_nc_db_file, average_every_secs=average_every_secs)

# plot random
random_db_folder = "20210929-061953"
random_db_file = f"./_log/no-learning/RANDOM/{random_db_folder}/log.db"
print(random_db_file)
# x_random_rewards, y_random_rewards = UtilsPlot.plot_data_in_deadline_over_time(0, random_db_file,
...
print(rr_db_file)
# x_rr_rewards, y_rr_rewards = UtilsPlot.plot_data_in_deadline_over_time(0, rr_db_file, average_every_secs=average_every_secs)

# least loaded
ll_db_folder = "20210929-061953"
ll_db_file = f"./_log/no-learning/LEAST_LOADED_AWARE/{ll_db_folder}/log.db"
print(ll_db_file)
x_ll_rewards, y_ll_rewards = UtilsPlot.plot_data_in_deadline_over_time(0, ll_db_file, average_every_secs=average_every_secs)
...
print(llna_db_file)
x_llna_rewards, y_llna_rewards = UtilsPlot.plot_data_in_deadline_over_time(0, llna_db_file, average_every_secs=average_every_secs)
...
print(llc_db_file)
x_llc_rewards, y_llc_rewards = UtilsPlot.plot_data_in_deadline_over_time(0, llc_db_file, average_every_secs=average_every_secs)

# plot
figure_filename = f"./_plots/in-deadline-over-time-versus_{Utils.current_time_string()}.pdf"
...
Plot.multi_plot([x_sarsa_rewards, x_sarsa_nc_rewards, x_llc_rewards, x_ll_rewards, x_llna_rewards],
                [x_sarsa_rewards, y_sarsa_nc_rewards, y_llc_rewards, y_ll_rewards, y_llna_rewards],
                x_label="Time (s)", y_label="iota (in-deadline rate)", fullpath=figure_filename, legend=LEGEND, show_markers=False)
